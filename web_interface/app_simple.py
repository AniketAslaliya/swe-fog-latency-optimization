"""
Fog Computing Simulator - Simple Web Server
===========================================

Simple HTTP server for the fog computing simulation platform.
This version serves static files directly without Flask templates.
"""
...
if __name__ == '__main__':
    print("🌐 Starting Fog Computing Simulator Web Interface")
    print("=" * 60)
